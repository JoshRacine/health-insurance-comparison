            ...
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 lg:sticky lg:top-4">
              ...
              <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <div className="space-y-4">
                  {/* POS 250 */}
                  <div>
                    <div className="text-sm font-medium text-gray-700 mb-2">POS 250</div>
                  ...
                  <div className="pt-2 border-t border-gray-200">
                    <div className="text-sm font-medium text-gray-700 mb-2">POS 500</div>
                    <div className="space-y-2">
                      <div>
                        <label className="block text-xs text-gray-500 mb-1">Monthly Premium</label>
                        <input
                  ...
                  {/* HDHP 3300 */}
                  <div className="pt-2 border-t border-gray-200">
                    <div className="text-sm font-medium text-gray-700 mb-2">HDHP 3300</div>
                    <div className="space-y-2">
                      <div>
                        <label className="block text-xs text-gray-500 mb-1">Monthly Premium</label>
                        <input
                      ...
                      <div>
                        <label className="block text-xs text-gray-500 mb-1">HSA Employer Contrib (Annual)</label>
                        <input
                          type="number"
                          min="0"
                          step="100"
